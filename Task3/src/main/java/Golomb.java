...
public class Golomb {
    ...
    public void model() {
        ...
        //SimpleDFS search = new SimpleDFS(store); // visited: 32059, failed: 16029
        Strategy1 search = new Strategy1(store); // visited: 40857, failed: 20428
        //Strategy2 search = new Strategy2(store); // visited: 701141, failed: 350570
        ...
        /* ========== Strategy 3 from JaCoP ========== */
        //Search<IntVar> search = new DepthFirstSearch<IntVar>();
        //SelectChoicePoint<IntVar> select = new SimpleSelect<IntVar>(numbers, new SmallestDomain<IntVar>(), new IndomainMax<IntVar>()); 
        //boolean result = search.labeling(store, select, cost) ^ true;
